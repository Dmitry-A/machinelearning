...
namespace AzureML
{
    internal class Executable
    {
        ...
        public async Task<int> RunAsync(Action<string> outputCallback = null, Action<string> errorCallback = null, TimeSpan? timeout = null, string stdIn = null)
        {
            ...
            var exitCodeTask = CreateWaitForExitTask(Process);
        ...
        public static Task<int> CreateWaitForExitTask(Process process, CancellationToken cancellationToken = default(CancellationToken))
        {
