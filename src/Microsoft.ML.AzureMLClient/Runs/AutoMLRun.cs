...
namespace Azure.MachineLearning.Services.Runs
{
    public class AutoMLRun : Run
    {
        ...
        //public async Task DownloadBestModelAsync(
        //    string metric = null,
        //    FileInfo downloadFilePath = null,
        //    Dictionary<string, List<string>> customHeaders = null,
        //    CancellationToken cancellationToken = default(CancellationToken))
        //{
        //    if (downloadFilePath != null)
        //    {
        //        Throw.IfDirectoryNotExists(downloadFilePath.Directory, nameof(downloadFilePath));
        //    }
